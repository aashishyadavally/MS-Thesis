...
\usepackage{hyperref}
% sorting=debug option lists the bibliography in the order of the
% listing ob BibTex entries in the references.bib file
...
\input{front_matter/copyright.tex}
\input{front_matter/approval.tex}
\input{front_matter/acknowledgements.tex}
\input{front_matter/contents.tex}
\input{front_matter/tables.tex}
\input{front_matter/figures.tex}
...
\input{chapter2/related_work.tex}
% Chapter 3: Multi-model Solar Irradiance Forecasting
\input{chapter3/multi_model.tex}
